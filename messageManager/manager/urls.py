...
from .views import index, MailingApiView, ClientApiView, MessageApiView, MailingItemApiView, ClientItemApiView
...
urlpatterns = [
    ...
    path('api/client/<int:client_id>/', ClientItemApiView.as_view()),
